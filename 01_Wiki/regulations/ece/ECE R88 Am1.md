...
region: ece
type: type/amendment
title: UNIFORM PROVISIONS CONCERNING THE APPROVAL OF RETRO-REFLECTIVE TYRES FOR TWO-WHEELED
  VEHICLES
description: 关于批准两轮车辆用回复反射轮胎的统一规定
status: active
entry_into_force_date: 2007-06-18
issuing_agency: UNECE
version: Amendment 1
source: E/ECE/324 Rev.1/Add.87/Amend.1, E/ECE/TRANS/505
tags:
- type/amendment
- reg/ece
- status/active
...
source_pdf: 国外法规\ECE标准\标准法规-UNECE\81~120\88\R088am1e.pdf
...
- field: 技术要求的限值
  ...
  extracted: null
  original: null
  note: 提供的B文本为修正案内容，未包含具体技术限值要求。
_ocr_upgraded: mineru_no_assets
_mineru_done_at: '2026-04-23'
_mineru_outputs_dir: outputs\964116f2d84ae43d
---

# Regulation No. 88 - Amendment 1

**Supplement 1 to the original version of the Regulation - Date of entry into force: 18 June 2007**

## 1. SCOPE
This Regulation applies to tyres, incorporating retro-reflecting devices, for vehicles of category L 1/ and cycles.
...
## 5.4.1.1. (Footnote renumbering and update)
The footnote referenced in paragraph 5.4.1.1 is renumbered as footnote 3/ and reads:
...
---
**Note:** This document is **Amendment 1** to Regulation No. 88. The text primarily shows amendments to specific paragraphs (1., 2., 2.1.3., 5.4.1.1.) and a footnote renumbering. The full regulation text is not provided in this excerpt.
