...
region: ece
type: type/amendment
title: UNIFORM PROVISIONS CONCERNING THE APPROVAL OF SEATS OF REAR-VIEW MIRRORS OF
  TWO-WHEELED POWER-DRIVEN VEHICLES WITH OR WITHOUT SIDE CAR, WITH REGARD TO THE MOUNTING
  OF REAR-VIEW MIRRORS ON HANDLEBARS
description: Amendment 2 to Regulation No. 81, concerning rear-view mirrors for two-wheeled
  vehicles.
source_file: 国外法规\ECE标准\标准法规-UNECE\81~120\81\R081am2e.pdf
entry_into_force_date: 2007-06-18
version: Amendment 2
standard_body: UNECE
tags:
- type/amendment
...
source_pdf: 国外法规\ECE标准\标准法规-UNECE\81~120\81\R081am2e.pdf
...
- field: 技术要求限值
  ...
  extracted: null
  original: null
  note: A 中未提取具体技术要求限值，B 中提供的文本为范围定义和脚注，不包含具体限值。
_ocr_upgraded: mineru_no_assets
_mineru_done_at: '2026-04-23'
_mineru_outputs_dir: outputs\ece2b42035d16848
---

**Regulation No. 81 - Amendment 2**

**Supplement 2 to the original version of the Regulation - Date of entry into force: 18 June 2007**

**UNIFORM PROVISIONS CONCERNING THE APPROVAL OF SEATS OF REAR-VIEW MIRRORS OF TWO-WHEELED POWER-DRIVEN VEHICLES WITH OR WITHOUT SIDE CAR, WITH REGARD TO THE MOUNTING OF REAR-VIEW MIRRORS ON HANDLEBARS**

**1. SCOPE**
This Regulation applies:
1.1. To rear view mirrors intended to be installed on vehicles of categories L 1/ without bodywork partly or wholly enclosing the driver and
1.2. To the installation of rear view mirrors on vehicles of category L without bodywork partly or wholly enclosing the driver 2/.
